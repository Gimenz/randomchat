...
*#daftar* _nomor_  : menambahkan nomor WhatsApp ke dalam database, kamu juga bisa menambahkan no wa temen kamu
_contoh:_ #daftar 62852361555489
...
#ban : banned nomor (user banned tidak dapat menggunakan fitur bot)
...
exports.textAbout = () => {
    return `
▸ *_About_*
Apa ini? Mirip Anonymous Chat Telegram, untuk Mengirim pesan rahasia ke seseorang, kamu cukup mengirimkan pesan dan bikin seseorang kepo denganmu`
}